...
#if defined(PNG_READ_gAMA_SUPPORTED) || defined(PNG_WRITE_gAMA_SUPPORTED) || defined(PNG_READ_GAMMA_SUPPORTED)
...
#if defined(PNG_READ_tEXt_SUPPORTED) || defined(PNG_WRITE_tEXt_SUPPORTED) || defined(PNG_READ_zTXt_SUPPORTED) || defined(PNG_WRITE_zTXt_SUPPORTED)
...
#if defined(PNG_READ_tRNS_SUPPORTED) || defined(PNG_WRITE_tRNS_SUPPORTED) || defined(PNG_READ_EXPAND_SUPPORTED) || defined(PNG_READ_BACKGROUND_SUPPORTED)
...
#if defined(PNG_READ_bKGD_SUPPORTED) || defined(PNG_WRITE_bKGD_SUPPORTED) || defined(PNG_READ_BACKGROUND_SUPPORTED)
...
#if defined(PNG_READ_tRNS_SUPPORTED) || defined(PNG_READ_BACKGROUND_SUPPORTED) || defined(PNG_READ_EXPAND_SUPPORTED) || defined(PNG_READ_BACKGROUND_SUPPORTED)
...
#define png_debug(l,m)        if (PNG_DEBUG > l) fprintf(PNG_DEBUG_FILE,"%s"m,(l==1 ? "\t" : (l==2 ? "\t\t":(l>2 ? "\t\t\t":""))))
#define png_debug1(l,m,p1)    if (PNG_DEBUG > l) fprintf(PNG_DEBUG_FILE,"%s"m,(l==1 ? "\t" : (l==2 ? "\t\t":(l>2 ? "\t\t\t":""))),p1)
#define png_debug2(l,m,p1,p2) if (PNG_DEBUG > l) fprintf(PNG_DEBUG_FILE,"%s"m,(l==1 ? "\t" : (l==2 ? "\t\t":(l>2 ? "\t\t\t":""))),p1,p2)
#endif /* (PNG_DEBUG > 0) */
#endif /* PNG_DEBUG */
#ifndef png_debug
...
#  define png_composite(composite, fg, alpha, bg)                            { png_uint_16 temp = ((png_uint_16)(fg) * (png_uint_16)(alpha) +        (png_uint_16)(bg)*(png_uint_16)(255 -                (png_uint_16)(alpha)) + (png_uint_16)128);           (composite) = (png_byte)((temp + (temp >> 8)) >> 8); }

#  define png_composite_16(composite, fg, alpha, bg)                         { png_uint_32 temp = ((png_uint_32)(fg) * (png_uint_32)(alpha) +        (png_uint_32)(bg)*(png_uint_32)(65535L -             (png_uint_32)(alpha)) + (png_uint_32)32768L);        (composite) = (png_uint_16)((temp + (temp >> 16)) >> 16); }

#else  /* standard method using integer division */

#  define png_composite(composite, fg, alpha, bg)                            (composite) = (png_byte)(((png_uint_16)(fg) * (png_uint_16)(alpha) +    (png_uint_16)(bg) * (png_uint_16)(255 - (png_uint_16)(alpha)) +       (png_uint_16)127) / 255)

#  define png_composite_16(composite, fg, alpha, bg)                         (composite) = (png_uint_16)(((png_uint_32)(fg) * (png_uint_32)(alpha) + (png_uint_32)(bg)*(png_uint_32)(65535L - (png_uint_32)(alpha)) +      (png_uint_32)32767) / (png_uint_32)65535L)
...
#define PNG_COLOR_DIST(c1, c2) (abs((int)((c1).red) - (int)((c2).red)) + abs((int)((c1).green) - (int)((c2).green)) + abs((int)((c1).blue) - (int)((c2).blue)))
...
#if defined(PNG_WRITE_tEXt_SUPPORTED) || defined(PNG_WRITE_zTXt_SUPPORTED) || defined(PNG_WRITE_pCAL_SUPPORTED)
