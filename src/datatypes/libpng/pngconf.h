...
#endif
#if !defined(PNG_WRITE_TRANSFORMS_NOT_SUPPORTED) && !defined(PNG_NO_WRITE_TRANSFORMS)
...
#if !defined(PNG_NO_PROGRESSIVE_READ) && !defined(PNG_PROGRESSIVE_READ_NOT_SUPPORTED) /* if you don't do progressive   */
...
#if !defined(PNG_READ_ANCILLARY_CHUNKS_NOT_SUPPORTED) && !defined(PNG_NO_READ_ANCILLARY_CHUNKS)
#define PNG_READ_ANCILLARY_CHUNKS_SUPPORTED
#endif
#if !defined(PNG_WRITE_ANCILLARY_CHUNKS_NOT_SUPPORTED) && !defined(PNG_NO_WRITE_ANCILLARY_CHUNKS)
