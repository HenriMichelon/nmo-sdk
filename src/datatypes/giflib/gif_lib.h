...
* 24.01.00 - Added EXPORTED for use in the NMO SDK / WIN32 version
******************************************************************************/
...
EXPORTED GifFileType *DGifOpenFileName(const char *GifFileName);
EXPORTED GifFileType *DGifOpenFileHandle(int GifFileHandle);
EXPORTED int DGifSlurp(GifFileType *GifFile);
EXPORTED int DGifGetScreenDesc(GifFileType *GifFile);
EXPORTED int DGifGetRecordType(GifFileType *GifFile, GifRecordType *GifType);
EXPORTED int DGifGetImageDesc(GifFileType *GifFile);
EXPORTED int DGifGetLine(GifFileType *GifFile, GifPixelType *GifLine, int GifLineLen);
EXPORTED int DGifGetPixel(GifFileType *GifFile, GifPixelType GifPixel);
EXPORTED int DGifGetComment(GifFileType *GifFile, char *GifComment);
EXPORTED int DGifGetExtension(GifFileType *GifFile, int *GifExtCode,
						GifByteType **GifExtension);
EXPORTED int DGifGetExtensionNext(GifFileType *GifFile, GifByteType **GifExtension);
EXPORTED int DGifGetCode(GifFileType *GifFile, int *GifCodeSize,
						GifByteType **GifCodeBlock);
EXPORTED int DGifGetCodeNext(GifFileType *GifFile, GifByteType **GifCodeBlock);
EXPORTED int DGifGetLZCodes(GifFileType *GifFile, int *GifCode);
EXPORTED int DGifCloseFile(GifFileType *GifFile);
...
EXPORTED extern int GifLastError(void);
