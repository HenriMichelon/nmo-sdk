...
$Id: IKeybMacOS.cpp,v 1.2 2002/11/29 14:26:06 hmichelon Exp $
--------------------------------------------------------------------------*/
...
//-------------------------------------------------------
void IKeyb :: SetModifiers(EventRef event) 
{
	UInt32 kcode;
	GetEventParameter(event, kEventParamKeyModifiers, typeUInt32, 
					NULL, sizeof(kcode), NULL, &kcode);
	os = (kcode & cmdKey) != 0;
	alt = (kcode & optionKey) != 0;
	ctrl = (kcode & controlKey) != 0;
	shift = (kcode & shiftKey) != 0;
	capslock = (kcode & 1024) != 0;
}
